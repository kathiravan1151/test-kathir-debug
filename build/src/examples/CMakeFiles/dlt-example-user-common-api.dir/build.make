...
src/examples/CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.o: ../src/examples/dlt-example-user-common-api.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/dlt-daemon/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object src/examples/CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.o"
	cd /mnt/dlt-daemon/build/src/examples && /usr/bin/aarch64-linux-gnu-gcc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.o   -c /mnt/dlt-daemon/src/examples/dlt-example-user-common-api.c
...
src/examples/CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.i: cmake_force
	...
	cd /mnt/dlt-daemon/build/src/examples && /usr/bin/aarch64-linux-gnu-gcc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /mnt/dlt-daemon/src/examples/dlt-example-user-common-api.c > CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.i
...
src/examples/CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.s: cmake_force
	...
	cd /mnt/dlt-daemon/build/src/examples && /usr/bin/aarch64-linux-gnu-gcc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /mnt/dlt-daemon/src/examples/dlt-example-user-common-api.c -o CMakeFiles/dlt-example-user-common-api.dir/dlt-example-user-common-api.c.s
...
src/examples/dlt-example-user-common-api: src/lib/libdlt.so.2.18.4
src/examples/dlt-example-user-common-api: src/examples/CMakeFiles/dlt-example-user-common-api.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/dlt-daemon/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable dlt-example-user-common-api"
	cd /mnt/dlt-daemon/build/src/examples && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/dlt-example-user-common-api.dir/link.txt --verbose=$(VERBOSE)
...
src/examples/CMakeFiles/dlt-example-user-common-api.dir/clean:
	cd /mnt/dlt-daemon/build/src/examples && $(CMAKE_COMMAND) -P CMakeFiles/dlt-example-user-common-api.dir/cmake_clean.cmake
...
src/examples/CMakeFiles/dlt-example-user-common-api.dir/depend:
	cd /mnt/dlt-daemon/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/dlt-daemon /mnt/dlt-daemon/src/examples /mnt/dlt-daemon/build /mnt/dlt-daemon/build/src/examples /mnt/dlt-daemon/build/src/examples/CMakeFiles/dlt-example-user-common-api.dir/DependInfo.cmake --color=$(COLOR)
